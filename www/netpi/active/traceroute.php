...
<form action="tracerouteworker.php" method="post">
<table width="375" border="0">
  <tr>
    <td>
          <table width="100%" border="0">
        <tr>
          <td><b>Address to Traceroute:</b>
<input type="text" id="ipbox" name="ip" value="www.google.com" maxlength="50" class="display" readonly="readonly" />
		  </td>
        </tr>
        <tr>
          <td>
		<table id="keypad" width="100%" border="0">
          ...
          <table id="submitbtn" width="100%" border="0">
            <tr>
              <td><input type="Submit" value="TRACEROUTE!"/></td>
            </tr>
          </table></td>
    <td><b>
